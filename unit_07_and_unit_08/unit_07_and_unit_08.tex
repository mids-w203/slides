...
Where $s$ is a weighted average of the sample standard deviations for each group, $s_X$ and $s_Y$.
  $$
    s = \sqrt{ \left(\frac{ (n_{1}-1)s_X^{2} + (n_{2}-1)s_Y^{2} }{ n_{1}+n_{2}-2 }\right) }
  $$

\begin{exampleblock}{Result}
$t$ has a T distribution with $n_1 + n_2 -2$ degrees of freedom.
  \end{exampleblock}
