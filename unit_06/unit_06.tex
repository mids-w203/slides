...
\begin{frame}{Two Branches of Statistics}
    \begin{center}
        \includegraphics[width=1.0\textwidth]{figures/two_branches_of_statistics.png}
    \end{center}
\end{frame}
%End of Section 6.1 Edits



%Start of Section 6.4 Edits
...
\begin{frame}{Guidelines for Statistical Reporting}
  \begin{itemize}
...
\begin{frame}{Guideline Five (cont.)}
\begin{exampleblock}{Remember the difference between sample and population}
  \begin{itemize}
...
\begin{frame}{Guideline Six (cont.)}
\begin{exampleblock}{Show us the code (a guideline for this class)}
  \begin{itemize}
